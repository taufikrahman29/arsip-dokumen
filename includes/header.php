...
$page_title = $page_title ?? 'Sistem Informasi Arsip Dokumen';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title><?= sanitize($page_title); ?> — Lapas Kelas IIA Bekasi</title>
    <meta name="description" content="Sistem Informasi Pengelolaan dan Penyimpanan Dokumen Resmi Lapas Kelas IIA Bekasi">
    <!-- Favicon -->
